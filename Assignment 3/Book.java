public class Book
{
	...
	public Book(String t, double p) throws InvalidPriceException
	{
		title = t;
		if (p < 0)
	...
	public Book(String t, double p, String i, String g) throws InvalidPriceException, InvalidGenreException
	{
		title = t;
		if (p < 0)
			throw new InvalidPriceException("Price cannot be negative.");
		...
		price = p;
		ISBN = i;
		if (!g.equalsIgnoreCase("fiction") && !g.equalsIgnoreCase("autobiography") && !g.equalsIgnoreCase("poetry") && !g.equalsIgnoreCase("short stories"))
			throw new InvalidGenreException("Invalid Genre specified.");
		genre = g;
	}
